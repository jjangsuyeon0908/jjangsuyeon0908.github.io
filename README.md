...
> 👋 안녕하세요!   
저는 4년 차 웹 퍼블리셔이자 프론트엔드 개발자로 성장하고 있는 장수연입니다.  
웹사이트를 더 보기 좋고 편리하게 만드는 걸 좋아해서, 반응형 웹과 UI/UX 개선 작업을 즐겨왔어요. <br><br> 
단순히 디자인을 구현하는 것보다, “사용자가 쓰기 편한가?”를 먼저 고민하고 유지보수하기 쉬운 코드를 짜려고 노력합니다. 최근에는 Vue.js와 React 같은 프레임워크를 활용해 퍼블리셔 경험을 프론트엔드 개발로 확장하고 있어요.  <br><br>
새로운 기술을 배우고 실험하는 걸 좋아해서, 사이드 프로젝트와 학습 기록을 GitHub에 차곡차곡 쌓아가는 중입니다. 🚀  
